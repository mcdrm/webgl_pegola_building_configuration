        ...
        <div className="building-controller">
            <div className="control-section">
                ...
                <ul className="dropdown-menu">
                    <li><p className="dropdown-item" href="#" onClick={() => handleOptionClick('building', 'wood')}>● Type 1</p></li>
                    <li><p className="dropdown-item" href="#" onClick={() => handleOptionClick('building', 'metal')}>● Type 2</p></li>
                    <li><p className="dropdown-item" href="#" onClick={() => handleOptionClick('building', 'stone')}>● Type 3</p></li>
                </ul>
                <div className="vl" />
