...
export const App = () => (
  <Canvas camera={{ position: [0, 0, 500], fov: 45 }} style={{ backgroundColor: 'grey' }}>
    <hemisphereLight intensity={0.5} color="white" groundColor="black" />
    <Environment
      files="https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/2k/evening_road_01_2k.hdr"
      ground={{ height: 55, radius: 300, scale: 700 }}
      // background
    />
    ...
    <OrbitControls autoRotateSpeed={0.85} zoomSpeed={0.75} />
  </Canvas>
)
